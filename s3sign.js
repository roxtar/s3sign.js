  ...
  (function() {
    var s3sign = (function() {
      ...
      function encode(secretKey, canonicalString, urlEncode) {
        var crypto;
        if (typeof CryptoJS === "undefined" && typeof require !== "undefined") {
          crypto = require("crypto-js");
        } else {
          crypto = CryptoJS; 
        }
        var hmac = crypto.HmacSHA1(canonicalString, secretKey);
        var b64 = hmac.toString(crypto.enc.Base64);
        if (urlEncode) {
    ...
    if (typeof module !== "undefined" && 
      ...
      module.exports.generateSignedUrl = s3sign.generateSignedUrl; 
    } else {
      window.s3sign = s3sign; 
    }
  })();
}
